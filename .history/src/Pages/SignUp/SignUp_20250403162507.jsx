...
export default function SignUp() {
 ...
 const {values , handleChange , handleSubmit , errors , touched , onb} = useFormik({
    initialValues,
    onSubmit,
    // validationSchema,
  })
      ...
      <div className="d-flex flex-column flex-md-row">
       ...
       <h4 className='mb-2'>Register Now :</h4> 
        ...
        <Form.Group className="mb-3"  controlId="formBasicName">
          ...
          <Form.Control isInvalid={!!errors.name} value={values.name} onChange={handleChange} name='name' type="text" placeholder="Enter Name" />   
