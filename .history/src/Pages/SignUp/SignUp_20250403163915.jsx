...
const validationSchema = Yup.object({
  name: Yup.string().required("Name Is Required").min(3,"Name Must be at Least 3 Characters").max(20,"Name Must be atmmost")
})
      ...
      <div className="d-flex flex-column flex-md-row">
       ...
       <h4 className='mb-2'>Register Now :</h4> 
        ...
        <Form.Group className="mb-3"  controlId="formBasicName">
          ...
          <Form.Control isInvalid={touched.name && !!errors.name} value={values.name} onBlur={handleBlur} onChange={handleChange} name='name' type="text" placeholder="Enter Name" />   
         ...
         <Form.Group className="mb-3" controlId="formBasicEmail">
          ...
          <Form.Control value={touched.email && values.email} onBlur={handleBlur} onChange={handleChange} name='email'  type="email" placeholder="Enter email" />         
        </Form.Group>
